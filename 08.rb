input = 'gea agfcbe egcbfd aecb cegbf cafgde fgeba ea gabdf begfdca | bcfeg ea fbdga fbgcdae
...
input.each do |i|
  i[1].split do |a|
    count+=1 if [2,3,4,7].include?(a.length)
  end
end
...
input.each do |i|
  ...
  right=[]
  n = i[0].split.sort_by {|x| x.length}.map{|x|x.chars.sort.join}
  numbers[1]=n[0]
  right.push(n[0][0], n[0][1])
  top = (n[1].chars.to_set ^ right.to_set).to_a.join
  numbers[4]=n[2]
  numbers[7]=n[1]
  numbers[8]=n[9]
  if (n[8].chars.to_a - n[2].chars.to_a).length == 2
    numbers[9]=n[8]
    if (n[7].chars.to_a - n[0].chars.to_a).length == 4
      numbers[0]=n[7]
      numbers[6]=n[6]
    else
      numbers[0]=n[6]
  ...
  elsif (n[7].chars.to_a - n[2].chars.to_a).length == 2
    numbers[9]=n[7]
    if (n[8].chars.to_a - n[0].chars.to_a).length == 4
      numbers[0]=n[8]
      numbers[6]=n[6]
    else
      numbers[0]=n[6]
  ...
  if (n[5].chars.to_a - n[0].chars.to_a).length == 3
    numbers[3]=n[5]
    if (n[4].chars.to_a - numbers[6].chars.to_a).length == 1
      numbers[2]=n[4]
      numbers[5]=n[3]
    else
      numbers[2]=n[3]
  ...
  elsif (n[4].chars.to_a - n[0].chars.to_a).length == 3
    numbers[3]=n[4]
    if (n[3].chars.to_a - numbers[6].chars.to_a).length == 1
      numbers[2]=n[3]
      numbers[5]=n[5]
    else
      numbers[2]=n[5]
    ...
    numbers[3]=n[3]
    if (n[5].chars.to_a - numbers[6].chars.to_a).length == 1
      numbers[2]=n[5]
      numbers[5]=n[4]
    else
      numbers[2]=n[4]
  ...
  numbers = numbers.map{|x|x.chars.sort.join}
  answers = i[1].split.map{|x|x.chars.sort.join}
  str = ''
  answers.each do |a|
    str+=numbers.index(a).to_s
  end
  sum+=str.to_i
end
